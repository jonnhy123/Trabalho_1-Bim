...
public class Start extends SqlGen{
	...
	@Override
	protected String getCreateTable(Connection con, Object cl) {
		try {
			...
			{
				String nomeTabela;
				if (((AccessibleObject) cl).isAnnotationPresent(Tabela.class)) {

					Tabela anotacaoTabela = ((AccessibleObject) cl).getAnnotation(Tabela.class);
					nomeTabela = anotacaoTabela.value();

				} else {
					nomeTabela = ((Class<?>) cl).getSimpleName().toUpperCase();

				}
				sb.append("CREATE TABLE ").append(nomeTabela).append(" (");
			}

			Field[] atributos = ((Class<?>) cl).getDeclaredFields();
